...
/// </summary>
public class DynamicSourceMapperOperator : MapperOperator
{
    private List<BuildMember> runTimeMembers { get; set; }

    /// <summary>
    /// Creates a new <see cref="DynamicSourceMapperOperator"/> instance.
    /// </summary>
    ...
    public DynamicSourceMapperOperator(MapperBuilder builder, BuildType sourceType, BuildType targetType, MapperOperator? parent = null, MapperOperatorLogDelegate? onLog = null) : base(builder, sourceType, targetType, parent, onLog)
    {
    }
    ...
    {
        return SourceType.MemberResolver.GetType() == typeof(DynamicMemberResolver) && TargetType.MemberResolver.HasMembers;
    }
